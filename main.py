...
def play_rovix_greedy(user_currency, admin_bal, total_bets):
    ...
    choice =  "0" # input("Choose an option: ").strip()
    ...
    if choice == '0':
        ...
        pack_choice =  "0" # input("Select a pack option (1-7): ").strip()
        ...
        creator_name =  "0" # input("Enter Creator Name to gift: ").strip()
        if not creator_name:
            print("❌ Invalid creator name!")
            return user_currency, admin_bal, total_bets
            
        try:
            gift_amt = int( "0" # input("Enter cheers amount to gift: "))
        except ValueError:
            print("❌ Invalid input!")
            return user_currency, admin_bal, total_bets
        ...
        try:
            bet = int( "0" # input("Enter your bet amount: "))
        except ValueError:
